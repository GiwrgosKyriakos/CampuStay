...
const MOCK_INTERACTION_LOG = {
  leadScore: "85/100",
  leadQuality: "Υψηλό ενδιαφέρον",
  visitedProperties: ["2άρι Ζωγράφου (45m²)", "Studio Κυψέλη (32m²)"],
  callInquiries: ["3άρι Παγκράτι (2 κλήσεις - 24/08)", "Loft Εξάρχεια (1 κλήση)"],
  questionsAsked: [
    "Δυνατότητα κατοικίδιου (μικρός σκύλος)",
    "Εκτιμώμενα μηνιαία κοινόχρηστα",
    "Διαθεσιμότητα επίπλωσης",
  ],
  cancellationNote: "1 ακύρωση (ειδοποίηση 2 ώρες πριν)",
};
