      ...
      >
        <View style={styles.header}>
          ...
          <Pressable style={styles.feedLink} onPress={() => router.push("/notification-feed" as never)} testID="open-notification-feed">
            ...
            <Text style={styles.feedLinkText}>{t("notifications.feedHistory")}</Text>
