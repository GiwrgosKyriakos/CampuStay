...
exports.DEFAULT_DEAL_CHECKLIST = void 0;
exports.seedDealChecklist = seedDealChecklist;
exports.getChecklistItems = getChecklistItems;
exports.assertChecklistVerified = assertChecklistVerified;
const app_1 = require("firebase-admin/app");
const firestore_1 = require("firebase-admin/firestore");
if ((0, app_1.getApps)().length === 0)
    (0, app_1.initializeApp)();
const db = (0, firestore_1.getFirestore)();
exports.DEFAULT_DEAL_CHECKLIST = [
...
async function seedDealChecklist(dealId) {
    const batch = db.batch();
    exports.DEFAULT_DEAL_CHECKLIST.forEach((item) => {
        batch.set(db.doc(`deals/${dealId}/checklist/${item.id}`), item, { merge: true });
    });
    await batch.commit();
}
async function getChecklistItems(dealId) {
    const snapshot = await db.collection(`deals/${dealId}/checklist`).get();
    return snapshot.docs;
}
async function assertChecklistVerified(dealId, targetStage) {
...
//# sourceMappingURL=dealChecklist.js.map