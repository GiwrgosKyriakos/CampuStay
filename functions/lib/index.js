...
exports.generateListingCopywriting = exports.generateCmaReport = exports.reviewClaimCallable = exports.reviewChecklistDocumentCallable = exports.reassignLeadCallable = exports.recordShowingFeedbackCallable = exports.recordKeySafeActionCallable = exports.recordAcceptedOfferCallable = exports.publishListingAssignmentCallable = exports.migrateLegacyDealsCallable = exports.initializeDealCallable = exports.finalizeCommissionSettlementCallable = exports.finalizeChecklistDocumentUploadCallable = exports.ensureBrokerClientRelationshipCallable = exports.delegateShowingCallable = exports.createCrossBrokerShowingCallable = exports.claimPropertyCallable = exports.claimLeadCallable = exports.advanceDealStageCallable = exports.issueFiscalInvoice = exports.verifyContractSignatureAuditTrailCallable = exports.verifySigningOtp = exports.updateContractSignerIdentity = exports.updateContractPayload = exports.sendSigningOtp = exports.recordSigningEvidence = exports.getContractDownloadUrl = exports.onContractCompleted = exports.onAgencyPoolLeadWritten = exports.onAgencyPoolApartmentWritten = exports.onCanonicalDealStageUpdated = exports.onChecklistItemUpdated = exports.onDealRecordCreated = exports.onBrokerApprovalUpdated = exports.onContractStatusUpdatedForNotification = exports.onListingDocumentsUpdated = exports.onApprovedOfferUpdated = exports.onApprovedOfferCreated = exports.onOfferUpdated = exports.onOfferCreated = exports.onAppointmentUpdated = exports.onAppointmentCreated = exports.onListingWithdrawalEventCreated = exports.onListingWithdrawal = exports.onNewChatMessage = exports.reassignExpiredLeadsCron = exports.scheduledMailOutbox = exports.scheduledAnalyticsAggregation = exports.scheduledDealStagnation = exports.scheduledVisitReminders = void 0;
exports.onBrokerRegistration = exports.onMatchCreated = exports.onApartmentUpdate = exports.generateOwnerPerformanceReport = exports.generatePropertyListingCopy = exports.getComparativeMarketAnalysis = exports.getPropertyFeedbackSentiment = exports.buildOwnerActivityPdfReport = exports.analyzeShowingFeedbackSentiment = void 0;
...
const reassignExpiredLeads_1 = require("./scheduled/reassignExpiredLeads");
Object.defineProperty(exports, "reassignExpiredLeadsCron", { enumerable: true, get: function () { return reassignExpiredLeads_1.reassignExpiredLeadsCron; } });
const mailOutbox_1 = require("./cron/mailOutbox");
const issueFiscalInvoice_1 = require("./invoicing/issueFiscalInvoice");
Object.defineProperty(exports, "issueFiscalInvoice", { enumerable: true, get: function () { return issueFiscalInvoice_1.issueFiscalInvoice; } });
...
const brokerClientRelationships_1 = require("./callables/brokerClientRelationships");
Object.defineProperty(exports, "ensureBrokerClientRelationshipCallable", { enumerable: true, get: function () { return brokerClientRelationships_1.ensureBrokerClientRelationshipCallable; } });
...
Object.defineProperty(exports, "recordAcceptedOfferCallable", { enumerable: true, get: function () { return dealPipeline_1.recordAcceptedOfferCallable; } });
...
Object.defineProperty(exports, "onAgencyPoolApartmentWritten", { enumerable: true, get: function () { return notificationLifecycle_1.onAgencyPoolApartmentWritten; } });
Object.defineProperty(exports, "onAgencyPoolLeadWritten", { enumerable: true, get: function () { return notificationLifecycle_1.onAgencyPoolLeadWritten; } });
...
exports.onMatchCreated = (0, firestore_2.onDocumentWritten)({ document: "matches/{matchId}", region: "europe-west1" }, async (event) => {
    ...
    if (data.source === "roommate_swipe") {
        ...
        await Promise.all(matchedUsers.map(async (matchedRecipientId) => {
            ...
            if (notificationSettings.new_matches === false || recipientData.newMatchesEnabled === false || notificationSettings.mute_all_notifications === true)
                return;
            await (0, push_1.sendPushToUser)(matchedRecipientId, {
                type: "high_match",
