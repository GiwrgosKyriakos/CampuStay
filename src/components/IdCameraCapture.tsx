...
export interface IdCameraCaptureProps {
  ...
  frontUrl?: string;
  backUrl?: string;
  onUploaded: (side: IdSide, url: string) => void;
  onClose: () => void;
}

export default function IdCameraCapture({ visible, contractId, signerId, frontUrl, backUrl, onUploaded, onClose }: IdCameraCaptureProps) {
          ...
          {!permission ? (
            ...
            <>
              ...
              <View style={styles.actionRow}>
                ...
                <Pressable style={[styles.secondaryButton, { backgroundColor: colors.surfaceSecondary, borderColor: colors.border }]} onPress={onClose} testID="esign-id-camera-done">
...
const styles = StyleSheet.create({
  ...
  sheet: { maxHeight: "92%", padding: spacing.lg, borderTopLeftRadius: radius.lg, borderTopRightRadius: radius.lg, borderWidth: 1, gap: spacing.md },
